...
def encryption():
    ...
    _from_mins = request.args["From_mins"]
    _from_secs = request.args["From_secs"]
    _to_date = request.args["To_date"]
    _to_hour = request.args["To_hour"]
    _to_mins = request.args["To_mins"]
    _to_secs = request.args["To_secs"]
    _data = request.args["Data"]
    _passwd = getPassword(_from_date,_from_hour,_from_mins,_from_secs, _to_date,_to_hour,_to_mins, _to_secs)
